...
@pytest.mark.parametrize("password,hash_,expected",[
        ...
        ['password', '3b68ca4706cbae291455e4340478076c1e1618e742b6144cfcc3e50f648903e4:salt:0:1', True]
    ]
)
def test_verify(password, hash_, expected):
    assert encryptor.verify(password, hash_) == expected
